              ...
              {FUNCTIONS.map((func) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`relative z-10 w-10 h-10 rounded-lg flex items-center justify-center transition-colors duration-300 ${
                      isActive ? "bg-white/20" : "bg-accent/10"
                    }`}>
                      <Icon className={`w-5 h-5 transition-colors duration-300 ${isActive ? "text-white" : "text-accent"}`} />
                    </div>

                    <span className={`relative z-10 font-medium flex-grow transition-colors duration-300 ${
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                        <div className="relative w-full aspect-square max-w-md">
                          {/* Placeholder для изображения с градиентным фоном */}
                          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-accent/20 via-primary/10 to-transparent border border-white/10 shadow-xl shadow-accent/10 overflow-hidden">
                            {/* Иконка функции в центре как placeholder */}
                            <div className="absolute inset-0 flex items-center justify-center">
                              <div className="relative">
                                ...
                                {(() => {
                                  ...
                                  return <Icon className="relative w-24 h-24 text-accent/60" />;
                                })()}
                              </div>
                            </div>
